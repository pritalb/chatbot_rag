...
def process_queries(input_topic, output_topic, model_name, index_path, metadata_path, hf_llm_id, bootstrap_servers='kafka:9093'):
    ...
    for message in consumer:
        try:
            ...
            transformed_data = {"original_message": data, "transformed_message": response['answer']}
...
if __name__ == '__main__':
    ...
    process_queries(input_topic, output_topic, model_name, index_path, metadata_path, hf_llm_id)